...
class NewDoc extends React.Component {
  ...
  componentDidMount() {
    formAPI.getDocType().then(object => {
      if (object.success) {
        let data = object.data.map(d => {
          return {
            value: d.id,
            label: d.name,
          };
      ...
      <div className="qc-content qc-card">
        <div className="qc-content">
          ...
          <FormGroup>
            ...
            <Select styles={inputStyle} options={optionActor} />
          </FormGroup>
          <FormGroup>
            <Label>Loại hình tư liệu</Label>
            <Select styles={inputStyle} options={this.state.docTypeList} />
          </FormGroup>
          <FormGroup>
            <Label>Mức độ phổ biển</Label>
            <br />
            <Label>
              <input type="radio" value={0} name="rate" />
              Phổ biến
            </Label>
            <Label>
          ...
          <FormGroup>
            ...
            <br />
            <Label>
              <input type="radio" value={0} name="cost" />
              Miễn phí
            </Label>
            <Label>
              <input type="radio" value={1} name="cost" />
              Kinh phí, số tiền&nbsp;
          ...
          <FormGroup>
            ...
            <Select isMulti styles={inputStyle} options={optionActor} />
          </FormGroup>
          ...
          <FormGroup>
            ...
            <br />
            <Label>
              <input type="checkbox" /> Bảo quản tại Nhiệm vụ thành phần
            </Label>
            <br />
            <Label>
              <input type="checkbox" /> Bảo quản tại Văn phòng Quốc chí
            </Label>
          </FormGroup>
        </div>
