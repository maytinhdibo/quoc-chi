  ...
  render() {
    const columns = [
      ...
      },
      {
        ...
        Cell: props => (
          <Link
            to={"/dashboard/volumes/detail/" + props.original.id}
            className="number"
          >
            {props.original.name}
          </Link>
      ...
      },
      {
        ...
        Cell: props => (
          <span className="number">
            {this.userrender(props.original.users)}
          </span>
        )
      },
      {
        ...
        <div className="qc-content qc-card">
              ...
              <div className="tool-dropdown">
                <div className="content">
                  <ul class="qc-dropdown-ul">
                    <Link
                      to={`/dashboard/books/${this.props.match.params.id}/newvolume/`}
                    >
                      <li>
                        <span className="icon">
                    ...
                    <Link
                      to={`/dashboard/books/edit/${this.props.match.params.id}`}
                    >
                      <li>
                        <span className="icon">
          ...
          {this.state.loaded ? (
            <div className="qc-content">
              ...
              <p
                dangerouslySetInnerHTML={
                  this.state.data.book && {
                    __html: this.state.data.book.description
                  }
                }
              ></p>
              <hr />
              ...
              <p>
                {this.state.data.bookAdmin &&
                  this.state.data.bookAdmin.length > 0 &&
                  this.state.data.bookAdmin
                    .map(object => {
                      return (
