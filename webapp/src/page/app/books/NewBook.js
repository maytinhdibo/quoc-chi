...
class NewBook extends React.Component {
  ...
  createNew = () => {
    ...
    bookAPI
      .createBook({ description, name, adminValue })
      .then(object => {
        if (object.success) {
          alertText("Tạo quyển thành công.");
        } else {
          if (object.code == "NO_ROLE") {
            alertText(object.reason);
          } else {
            alertText("Có lỗi xảy ra, vui lòng kiểm tra lại dữ liệu.");
          }
        }
      })
      .catch(e => {
  ...
  render() {
    ...
    return (
      <div className="qc-content qc-card">
        <div className="qc-card-header">Thêm tập mới</div>
        <div className="qc-content">
          ...
          <CKEditor
            ...
            data="<p>Giới thiệu về tập mới...</p>"
            onInit={editor => {
