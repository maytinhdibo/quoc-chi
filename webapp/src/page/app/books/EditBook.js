...
class EditBook extends React.Component {
        ...
        formAPI.getUsers().then(object => {
            if (object.success) {
                ...
                analyticsAPI.getBook(this.props.match.params.id).then(object => {
                    if (object.success) {
                        this.setState({
                            name: object.data.book.name,
                            description: object.data.book.description,
                            adminValue: object.data.bookAdmin.map(object => {
                                return {
    ...
    editBook = () => {
        ...
        bookAPI.editBook({ description, name, adminValue }, this.props.match.params.id).then(object => {
            if (object.success) {
