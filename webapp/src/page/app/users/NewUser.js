    ...
    try {
      if (name && email && valueOrganization && valueTitle && valueUserRole) {
        let request = {
          ...
          optionUserRole: valueUserRole.value,
          optionEditorRole: {
              value: null
          }
        };
        ...
        if (valueUserRole.value == 2) {
          if (!valueEditorRole)
            throw new Error("Vui lòng chọn loại phụ trách.");
        ...
        userAPI
          ...
          .then(object => {
            if (object.success)
              alertText(
                "Tạo tài khoản thành công! Mật khẩu mặc định là phần trước @ của email."
              );
  ...
  render() {
    ...
    return (
      <div className="qc-content qc-card">
        <div className="qc-card-header">Thêm người dùng mới</div>
        <div className="qc-content">
          ...
          {this.state.valueUserRole && this.state.valueUserRole.value == 2 ? (
            <div>
              ...
              {this.state.valueEditorRole &&
              this.state.valueEditorRole.value > 0 ? (
                <div>
                  {" "}
                  <FormGroup>
                    <Label>Tập</Label>
                  ...
                  {this.state.valueEditorRole &&
                  this.state.valueEditorRole.value > 1 ? (
                    <div>
                      {" "}
                      <FormGroup>
                        <Label>Quyển</Label>
                      ...
                      {this.state.valueEditorRole &&
                      this.state.valueEditorRole.value > 2 ? (
                        <div>
                          {" "}
                          <FormGroup>
                            <Label>Mục</Label>
                            <Select
                              ...
                              onChange={value =>
                                this.setState({ valueChapter: value })
                              }
                              styles={inputStyle}
