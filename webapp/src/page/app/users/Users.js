  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        Cell: props => (
          <span className="number">
            {props.original.academic_title &&
              props.original.academic_title.name}
          </span>
        )
      },
      {
        ...
        Cell: props => (
          <Link className="name" to={"/dashboard/user/" + props.original.id}>
            <span>
              {props.original.name != null ? props.original.name : ""}
            </span>
          </Link>
        )
      },
      ...
      },
      {
        ...
        Cell: props => (
          <span className="number">
            {this.renderRole(props.original.books)}
          </span>
        )
      },
      {
        ...
        Cell: props => (
          <span className="number">
            {props.original.organization && props.original.organization.name}
          </span>
        )
      }
    ];
